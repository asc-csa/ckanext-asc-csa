    ...
    <div class="recline-flot"> \
      <div class="panel graph" style="display: block;"> \
        <div class="js-temp-notice alert alert-warning alert-block"> \
          ...
          <p>Veuillez sélectionner les champs que vous souhaitez représenter graphiquement dans le menu de droite.</p> \
          <p>Please select the fields that you would like to graph in the menu on the right.</p> \
        </div> \
      </div> \
    </div> \
',
    ...
    <form class="form-stacked"> \
      <div class="clearfix"> \
        <div class="form-group"> \
          <label>Type de graphique | Graph Type</label> \
          <div class="input editor-type"> \
            <select class="form-control"> \
              <option value="lines-and-points">Lignes et points | Lines and Points</option> \
              <option value="lines">Lignes | Lines</option> \
              <option value="points">Points</option> \
              <option value="bars">Barres | Bars</option> \
              <option value="columns">Colonnes | Columns</option> \
            </select> \
          </div> \
        </div> \
        <div class="form-group"> \
          <label>Axe horizontale | Horizontal Axis </label> \
          <div class="input editor-group"> \
            <select class="form-control"> \
              <option value="">SVP selectioner... | Please choose ...</option> \
                {{#fields}} \
      ...
      <div class="editor-buttons"> \
        <button class="btn btn-default editor-add">Ajouter une série | Add Series</button> \
      </div> \
      <div class="editor-buttons editor-submit" comment="hidden temporarily" style="display: none;"> \
        <button class="editor-save">Sauvegarder | Save</button> \
...
',
  templateSeriesEditor: ' \
    <div class="editor-series js-series-{{seriesIndex}}"> \
      <div class="form-group"> \
      <label>Série | Series <span>{{seriesName}}</span> \
      <br>[<a href="#remove" class="action-remove-series">Supprimer | Remove</a>] \
        </label> \
        <div class="input"> \
          <select class="form-control"> \
          {{#fields}} \
    ...
    <form class="form-stacked"> \
      <div class="clearfix"> \
        ...
        <div class="editor-field-type-geom" style="display:none"> \
          <label>Géométrie | Geometry (GeoJSON)</label> \
      ...
      <div class="editor-buttons"> \
      <button class="btn btn-default editor-update-map">Mettre à jour | Update</button> \
      </div> \
      <div class="editor-options" > \
        <label class="checkbox"> \
          <input type="checkbox" id="editor-auto-zoom" value="autozoom" checked="checked" /> \
          Zoom automatique sur les éléments | Auto zoom to features</label> \
        <label class="checkbox"> \
          <input type="checkbox" id="editor-cluster" value="cluster"/> \
          Indicateurs de regroupements | Cluster markers</label> \
      </div> \
...
my.ValueFilter = Backbone.View.extend({
  ...
  template: ' \
    <div class="filters"> \
    <h3>Filtres | Filters</h3> \
    <button class="btn js-add-filter add-filter">Ajouter un filtre | Add filter</button> \
      <form class="form-stacked js-add" style="display: none;"> \
        <fieldset> \
          <label>Field</label> \
          <select class="fields form-control"> \
